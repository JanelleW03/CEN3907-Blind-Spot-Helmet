...
# Script to set up machine learning environment for object detection on Raspberry Pi
# Taken from https://github.com/BashMocha/object-detection-on-raspberry-pi
