"""
Script for running object detection on Raspberry Pi using Pi Camera module.

Used for model testing and debugging; taken from https://github.com/BashMocha/object-detection-on-raspberry-pi
"""
